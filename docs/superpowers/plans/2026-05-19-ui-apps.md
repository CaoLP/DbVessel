...
- [ ] **Step 1: Cấu hình `apps/mobile/package.json`**
...
- [ ] **Step 2: Tạo cấu hình `apps/mobile/app.json`**
...
- [ ] **Step 3: Tạo cấu hình `apps/mobile/babel.config.js`**
...
- [ ] **Step 4: Tạo cấu hình `apps/mobile/tailwind.config.js`**
...
- [ ] **Step 5: Tạo `apps/mobile/tsconfig.json`**
...
- [ ] **Step 6: Chạy lệnh cài đặt thư viện**
...
- [ ] **Step 1: Thiết lập Root Layout `apps/mobile/app/_layout.tsx`**
...
- [ ] **Step 2: Tạo trang Connection Profiles `apps/mobile/app/index.tsx`**
...
- [ ] **Step 3: Tạo trang Chi tiết kết nối `apps/mobile/app/connection/[id].tsx`**
